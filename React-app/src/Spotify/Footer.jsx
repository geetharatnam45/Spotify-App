...
const Footer = () => {
  return (
    <div>
       <footer>
            <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 823.46 225.25"><g fill-rule="evenodd" class="svelte-19946z">
            ...
            <ul id='ul1'>
                ...
                <li className='li6'>For the Record</li>
            </ul>
            <ul id='ul2'>
                <h2 id='h2'>Communities</h2>
                <li className='li7'>For Artists</li>
                <li className='li8'>Developers</li>
                <li className='li9'>Advertising</li>
                <li className='li10'>Investors</li>
                <li className='li11'>Vendors</li>
            </ul>
            <ul id='ul3'>
                <h2 id='h3'>Useful links</h2>
                <li className='li12'>Support</li>
                <li className='li13'>Web Player</li>
                <li className='li14'>Free Mobile App</li>
                <li className='li15'>Import your <br /><b>music</b></li>
            </ul>
            <ul id='ul4'>
                <h2 id='h4'>Spotify Plans</h2>
                <li className='li16'>Premium <br /> <b>Standard</b></li>
                <li className='li17'>Premium <br /><b>Platinum</b></li>
                <li className='li18'>Premium <br /><b>Student</b></li>
                <li className='li19'>Spotify Free</li>
            </ul>
            <section id='section4'>
                <img src={instagram} alt="" className='demo1'/>
                <img src={excel} alt="" className='demo2' />
                <img src={Facebook} alt="" className='demo3'/>
            </section>
            <main className='nav1'>
                <nav className='sub-nav1'>
                     <ol>
                        <li>Legal </li>
